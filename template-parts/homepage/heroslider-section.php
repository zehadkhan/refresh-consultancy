...
<section class="hero-main">
	<div class="hero-slider-inner">
		<div class="owl-carousel">
			<?php
			if ( isset( $options['opt-group-home-slider-1'] ) && ! empty( $options['opt-group-home-slider-1'] ) ) {
				foreach ( $options['opt-group-home-slider-1'] as $item ) {
					?>
					<div class="item">
						<img src="<?php echo $item['opt-media-hero-slider-img']['url']; ?>"
